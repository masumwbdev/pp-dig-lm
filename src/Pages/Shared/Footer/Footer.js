        ...
        <div>
            <footer className="footer">
                <div className="footer-link">
                    <div>
                        <h4>Popular Diagnostic Ltd.</h4>
                        <hr className="w-75" />
                        <p className="px-4">The <span className="text-primary">Popular Diagnostic Ltd</span> started its journey with the vision of taking the health care services into a new height through providing the most accurate and reliable test results to all its customers and caring the patients at the top of its values.</p>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <Link className="footer-ancor-link" to="/doctors"><li>Doctors</li></Link>
